...
class ViolationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fee_amount' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'violations_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => 1,
                'fee_amount' => 'Lorem ipsum dolor sit amet',
                'violation_datetime' => '2019-10-14 01:23:48',
